...
export default function Registro() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (signUpError) {
      setSubmitError(signUpError.message || 'Erro ao registrar');
        ...
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <p className="text-center text-muted-foreground mt-2">
              Registre-se para acessar carrinho e favoritos
            </p>
          </CardHeader>
          ...
          <CardContent>
            {success ? (
              <div className="text-center space-y-4">
                ...
                <div>
                  <h3 className="font-semibold text-green-900 mb-2">Registro realizado com sucesso!</h3>
